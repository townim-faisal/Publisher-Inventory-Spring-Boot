...
@AnalyzerDef(name = "binderOrderBooks_analyzer",
...
public class BinderOrderBook {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator ="generateId")
    //@NotNull
    @Column(name = "id")
    @Field(index = Index.YES, store = Store.NO, analyze = Analyze.YES, analyzer=@Analyzer(definition="binderOrderBooks_analyzer"))
    private int id;
    ...
    public int getRemainingQuantity() {
        return (getOrderQuantity() - getReceivedQuantity());
    }
